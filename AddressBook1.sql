...
insert into addressBook (firstname,lastname,address,city,state,zip,phone,email) values ('Pavi','HC','Bangalore','Bangalore',
'Karnataka','586115','9591369901','srajesh@gmail.com' ),('Deepika','Ganorkar','Wadi','Nagpur','Maharashtra','440021','9422101502','deepikag@gmail.com')
,('Rohit','Sharma','Dattawadi','Nagpur','Maharashtra','440006','8626001501','rohit@gmail.com');
select *from addressBook;

update addressBook set phone = '9123456780' where firstname = 'Pavi';
