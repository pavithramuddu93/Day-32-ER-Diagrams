...
insert into employeePayroll (name,salary,startDate) values ('Pavi','30000','1-1-2022'), ('Kiran','40000','10-2-2022'), 
('Sarang', '50000', '25-2-2022'), ('Deepika', '40000', '10-2-2022'); 
select *from employeePayroll;
select salary from employeePayroll where name = 'Pavi';
...
update employeepayroll set phoneNum = '9172322399' where name ='Pavi';
update employeepayroll set phoneNum = '8626001571' where name ='Kiran';
update employeepayroll set phoneNum = '9422101501' where name ='Sarang';
update employeepayroll set address = 'Pune' where name ='Pavi';
update employeepayroll set address = 'Banglore' where name ='Kiran';
update employeepayroll set address = 'Nagpur' where name ='Sarang';
update employeepayroll set dept = 'Admin' where name ='Pavi';
update employeepayroll set dept = 'Tech' where name ='Kiran';
